describe('Currency Exchange test Test', () => {
	before(function () {
	...
	it('should fill transfer funds form form', () => {
		...
		cy.get('#tf_description').type('Una descripcion ahi')
	...
	it('should verify correct data', () => {
        ...
        cy.get('#tf_description').should('have.value', 'Una descripcion ahi')
